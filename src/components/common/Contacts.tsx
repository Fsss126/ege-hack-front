...
const Contacts: FunctionComponent<ContactsProps> = ({
  ...
  return (
    <div className="social-media font-light-grey">
      {vk && (
        <Link to={vk} className="social-media__link">
          <i className="fab fa-vk vk" />
        </Link>
      )}
      {fb && (
        <Link to={fb} className="social-media__link">
          <i className="fab fa-facebook-f fb" />
        </Link>
      )}
      {ok && (
        <Link to={ok} className="social-media__link">
          <i className="fab fa-odnoklassniki ok" />
        </Link>
      )}
      {ig && (
        <Link to={ig} className="social-media__link">
