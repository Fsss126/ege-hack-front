...
const CoursePrice = (props) => {
    const {isSelected, onSelect: callback, discount: discountInfo, error, retry} = props;
    ...
    return (
        <div className={classnames('layout__content-block', 'layout__content-block--stacked', 'course-overview__offer', {
                ...
                {purchased ? (
                    ...
                    discountInfo ? (
                        <React.Fragment>
                            ...
                            <div className="col-auto">
                                <Button onClick={onSelect}>{isSelected ? 'Выбрано' : 'Купить'}</Button>
                            </div>
                        </React.Fragment>
                    ) : (
                        <div className="col-auto">
