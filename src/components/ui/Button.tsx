...
export type ButtonProps<T extends React.ElementType = React.ElementType<JSX.IntrinsicElements['div']>> = {
...
const Button = <T extends React.ElementType>(props: ButtonProps<T>): ReactElement => {
