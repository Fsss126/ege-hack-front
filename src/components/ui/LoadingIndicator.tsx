...
export function useLoadingState(loading: null | boolean, done: boolean, rejected?: boolean, error?: boolean): LOADING_STATE {
    const [state, setState] = useState<LOADING_STATE>(loading === null || done
        ? LOADING_STATE.DONE
        : (rejected
...
export const LoadingIndicator: React.FC<LoadingIndicatorProps> = ({state, onClick, errorMessage}) => {
