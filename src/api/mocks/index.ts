import {
    ...
    SHOP_CATALOG,
    SUBJECTS,
    TEACHERS, TEST_STATE_NOT_STARTED, TEST_STATE_COMPLETED,
    WEBINAR_SCHEDULE, TEST, TEST_STATUS
} from "api/mocks/mocks";
import {AxiosInstance, AxiosRequestConfig, AxiosResponse} from "axios";
import {getUrl} from "../helpers";

const getMockedResponse = <T>(config: AxiosRequestConfig, data?: T): AxiosResponse => {
    return {
        data,
        status: 200,
        statusText: 'OK',
